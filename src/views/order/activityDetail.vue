<template>
  <div class="orderDetails">
    <div>
      <router-link :to="{path:'/order/activityOrder'}">
        <el-button type="primary">返回列表</el-button>
      </router-link>
    </div>
    <el-row class="mb20">
      <el-row :gutter="24" class="search-row">
        <el-col :span="24" class="title">活动信息</el-col>
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column prop="hotelInfo.hotelName" align="center" label="活动名称"></el-table-column>
          <el-table-column prop="hotelInfo.roomName" align="center" label="活动类型"></el-table-column>
          <el-table-column prop="hotelInfo.sourceType" align="center" label="标题"></el-table-column>
          <el-table-column prop="hotelInfo.roomStatus" align="center" label="活动地址"></el-table-column>
          <el-table-column prop="hotelInfo.roomPlanName" align="center" label="开始时间"></el-table-column>
          <el-table-column prop="hotelInfo.roomNumber" align="center" label="结束时间"></el-table-column>
          <el-table-column prop="hotelInfo.arrivalDate" align="center" label="活动发起人"></el-table-column>
          <el-table-column prop="hotelInfo.departureDate" align="center" label="发起人电话"></el-table-column>
        </el-table>
      </el-row>
      <el-row :gutter="24" class="search-row">
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="memberInfo.name" align="center" label="姓名/昵称"></el-table-column>
          <el-table-column prop="memberInfo.mobile" align="center" label="真实姓名"></el-table-column>
          <el-table-column prop="memberInfo.cardType" align="center" label="用户电话"></el-table-column>
          <el-table-column prop="memberInfo.mbName" align="center" label="是否是会员"></el-table-column>
        </el-table>
      </el-row>
      <el-row :gutter="24" class="search-row">
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="orderPay.sourceOrderNo" align="center" label="订单时间"></el-table-column>
          <el-table-column prop="orderPay.originPrice" align="center" label="订单状态"></el-table-column>
          <el-table-column prop="orderPay.sourceOrderNo" align="center" label="订单来源"></el-table-column>
        </el-table>
      </el-row>
      <el-row :gutter="24" class="search-row">
