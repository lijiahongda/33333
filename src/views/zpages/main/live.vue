    ...
    <div style="padding:20px">
      ...
      <div class="Setmeal"
        ...
        <el-table :data="tableData"
          ...
          <el-table-column prop="live_mobile"
                           label="播主"
                           width='200'>
          </el-table-column>
          <el-table-column prop="live_nickName"
                           label="播主昵称"
                           width='200'>
          </el-table-column>
          <el-table-column prop="live_number"
                           label="直播间人数">
          </el-table-column>
          ...
          <el-table-column prop="share_num"
                           label="转发次数">
          </el-table-column>
...
import { dataStatistics, userIndex, getUserLiveList } from "@/api/robot";
...
export default {
  ...
  methods: {
    ...
    downLoadEx () {
      ...
      getUserLiveList({ page: 1, pageSize: 10000, startTime: this.obj.startTime, endTime: this.obj.endTime }).then(res => {
        setTimeout(() => {
          loading.close();
        }, 300);
    ...
    getList () {
      ...
      getUserLiveList(this.obj).then(res => {
        setTimeout(() => {
          loading.close();
        }, 300);
