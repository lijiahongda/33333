<template>
  <div class="content" @click="showDownload">
      ...
      <el-form ref="form" label-width="120px" :inline="true">
        <div>
          <el-form-item label="群名称：">
            <el-input v-model="obj.name" placeholder="请输入群名称" clearable style="width:200px" />
          </el-form-item>
          ...
          <el-form-item label="标签">
            <el-select v-model="obj.tag_id" clearable style="width:200px">
              <el-option
          ...
          <el-form-item label="查询类型">
            <el-select v-model="obj.timeType" clearable style="width:200px">
              <el-option label="群创建时间" value="group">群创建时间</el-option>
              <el-option label="下单时间" value="order">下单时间</el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="机器人:">
            <el-select v-model="obj.wx_alias" clearable style="width:200px">
              <el-option
                v-for="(item,index) in tableData.wx_alias"
                :key="index"
                :label="item.wx_name"
                :value="item.wx_alias"
              >{{item.wx_name}}</el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="是否存在订单:">
            <el-select v-model="obj.haveOrder" clearable style="width:200px">
              <el-option label="是" :value="1">是</el-option>
              <el-option label="否" :value="2">否</el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="是否绑定群主:">
            <el-select v-model="obj.isBingGroupLeader" clearable style="width:200px">
              <el-option label="是" :value="1">是</el-option>
              <el-option label="否" :value="2">否</el-option>
            </el-select>
          </el-form-item>
    ...
    <div class="Setmeal">
      <el-table :data="tableData.data" style="width: 100%" @sort-change="sortChange">
        <el-table-column align="center" label="序号" width="80" prop="num"></el-table-column>
        <el-table-column align="center" label="群名称" width="320" prop="name"></el-table-column>
        <el-table-column align="center" label="标签" width="320" prop="name">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.tag_id"
              clearable
              style="width:200px"
              @change="scropeChange(scope.row.tag_id,scope.row.id,scope)"
            >
              <el-option
                v-for="(item,index) in tags"
                :key="index"
        ...
        <el-table-column align="center" label="机器人昵称" width="220" prop="wx_alias"></el-table-column>
        <el-table-column align="center" label="有效订单" width="120" prop="orderNum" sortable="custom"></el-table-column>
         <el-table-column prop="orderMember" label="下单用户数量" sortable="custom"></el-table-column>
        <el-table-column
          align="center"
          label="Gmv"
          width="120"
        ...
        <el-table-column
          ...
          sortable="custom"
        ></el-table-column>
        <el-table-column align="center" label="男性占比" prop="groupManProportion"></el-table-column>
        <el-table-column align="center" label="女性占比" prop="groupWomenProportion"></el-table-column>

        <el-table-column align="center" label="消息数量" prop="messageTotalNum"></el-table-column>
        <el-table-column align="center" label="素材条数" prop="fodderTotalNum"></el-table-column>
        <el-table-column align="center" label="链接点击量" width="140" prop="clickTotalNum"></el-table-column>
        <!-- <el-table-column align="center"  label="激活状态"  prop="robotStatus"></el-table-column> -->
        <el-table-column prop="adminName" label="管理员" width="180" align="center"></el-table-column>
        <el-table-column prop="mobile" label="群主手机号" width="180" align="center"></el-table-column>
        <!-- <el-table-column align="center"  label="机器人状态" width="140" prop="deleted_at"></el-table-column> -->
        <el-table-column prop="status" label="激活状态" align="center" width="140">
          <template slot-scope="scope">
            <el-button
              size="small"
              type="text"
              @click="statusChange(scope.row)"
            >{{scope.row.robotStatus}}</el-button>
        ...
        <el-table-column prop="status" label="操作" fixed="right" align="center" width="220">
          <template slot-scope="scope">
            <el-button size="small" type="text" @click="handleCheck(scope.row)">查看详情</el-button>
            <el-button size="small" type="text" @click="handleLookUser(scope.row)">查看群成员</el-button>
            <el-button size="small" type="text" @click="VieworderClick(scope.row)">查看群订单</el-button>
            <el-button
              size="small"
              type="text"
              @click="bindGroup(scope.row)"
              v-if="scope.row.band_group!=''"
            >{{scope.row.band_group}}</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    >
      <el-table :data="bindgroupInfo" style="width: 100%">
        ...
        <el-table-column prop="nickname" width="180" label="昵称"></el-table-column>
        <el-table-column prop="code_number" width="180" label="邀请码"></el-table-column>
        <el-table-column prop="mid" width="180" label="用户标识"></el-table-column>
      </el-table>
      ...
      <el-table :data="groupPhoneList" style="width: 100%">
        <el-table-column prop="mobile" label="手机号" width="180"></el-table-column>
        <el-table-column prop="truename" label="姓名" width="180"></el-table-column>
        <el-table-column prop="name" width="180" label="昵称"></el-table-column>
        <el-table-column prop="code_number" width="180" label="邀请码"></el-table-column>
        <el-table-column prop="mid" width="180" label="用户标识"></el-table-column>
      </el-table>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="groupupdate">更新</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    sortChange(column) {
      ...
      } else if (column.prop =='orderMember'){
        if(column.order=="ascending"){
          this.obj.rebate = "";
          this.obj.orderNum = "";
          this.obj.orderAmount = "";
          this.obj.groupMemberNum = "";
          this.obj.orderMember = "asc";
        }else{
          this.obj.rebate = "";
          this.obj.orderNum = "";
          this.obj.orderAmount = "";
          this.obj.groupMemberNum = "";
          this.obj.orderMember = "desc";
        }
      }
      this.obj.page = 1;
    ...
    scropeChange(tagid, id,scope) {
      console.log(tagid,id,scope.row);
	  var name,oldTagId;
      ...
      this.tags.forEach(ele=>{
      	if(scope.row.tag_name == ele.tag_name){
			oldTagId = ele.id;
		}
	  })
    ...
    VieworderClick(obj) {
      //点击查看群订单
      this.$router.push({ path: "/newOrder/list", query: { id: obj.id } });
    }
  }
};
</script>
