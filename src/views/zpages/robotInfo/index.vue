<template>
  <div class="main">
    <div class="Setmeal" style="min-height:10px; box-sizing: border-box;padding:20px">
      <el-form ref="form" label-width="120px" :inline="true">
        <el-form-item label="选择管理员">
          <el-select v-model="listForm.mid" clearable filterable placeholder="请选择管理员" style="margin-right:10px;">
            <el-option
    ...
    <div class="Setmeal" style="height:auto; box-sizing: border-box;padding:20px">
      <el-table :data="tableData" height="500" style="width: 100%" @sort-change="sortChange">
        <el-table-column prop="id" label="序号" width="120" align="center"></el-table-column>
        <el-table-column prop="code_number" label="机器人编号" width="220" align="center"></el-table-column>
        <el-table-column prop="wx_name" label="微信昵称" width="220" align="center"></el-table-column>
        <el-table-column prop="wx_alias" label="机器人微信号" width="220" align="center"></el-table-column>
        <el-table-column prop="bind_master" label="绑定群主数量" width="180" align="center" sortable="custom"></el-table-column>
        <el-table-column prop="bind_group_number" label="绑定群数量" width="180" align="center" sortable="custom"></el-table-column>
        <el-table-column prop="orderCount" label="订单数量" width="180" align="center" sortable="custom"></el-table-column>
        <el-table-column prop="orderPrice" label="GMV" width="180" align="center" sortable="custom"></el-table-column>
        <el-table-column prop="count_num" label="总群数量" width="180" align="center"></el-table-column>
        <el-table-column prop="on_line" label="登录状态" width="180" align="center"></el-table-column>
        ...
        <el-table-column prop="last_login_time" label="最后一次在线时间" width="180" align="center"></el-table-column>
        <el-table-column prop="status" label="操作" width="120" align="center" fixed="right">
